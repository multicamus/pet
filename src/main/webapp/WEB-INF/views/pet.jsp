...
/* SECTION - BIRTH */ .info#info__birth { display: flex; }
...
<link rel="stylesheet"
	href="/pet/assets/css/bootstrap-5.0.0-beta1.min.css">
<link rel="stylesheet" href="/pet/assets/css/LineIcons.2.0.css">
<link rel="stylesheet" href="/pet/assets/css/animate.css">
<link rel="stylesheet" href="/pet/assets/css/tiny-slider.css">
<link rel="stylesheet" href="/pet/assets/css/glightbox.min.css">
<link rel="stylesheet" href="/pet/assets/css/main.css">
</head>
							...
							<ul id="nav" class="navbar-nav ms-auto">
								<li class="nav-item"><a
									...
									<ul class="sub-menu collapse" id="submenu-1-1">
										<li class="nav-item"><a href="index.html">Home Style
												1</a></li>
								...
								<li class="nav-item"><a
									...
									aria-controls="navbarSupportedContent" aria-expanded="false"
									aria-label="Toggle navigation">Service</a>

									<ul class="sub-menu collapse" id="submenu-1-2">
										<li class="nav-item"><a href="service-1.html">Service
												Style 1</a></li>
								...
								<li class="nav-item"><a
									...
									href="contact(이용자정보열람).html" data-bs-toggle="collapse"
									data-bs-target="#submenu-1-4"
									aria-controls="navbarSupportedContent" aria-expanded="false"
									aria-label="Toggle navigation">마이페이지</a>

									<ul class="sub-menu collapse" id="submenu-1-4">
										<li class="nav-item"><a href="contact(이용자정보열람).html">이용자
												정보</a></li>
										<li class="nav-item"><a href="contact(펫시터입력정보).html">펫시터
												정보</a></li>
										<li class="nav-item"><a href="contact(반려견등록).html">반려동물
												선택</a></li>
									</ul></li>
								<!-- <li class="nav-item">
                                        <a class="page-scroll active" href="contact.html">마이페이지</a>
                                    </li> -->
							</ul>
