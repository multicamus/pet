		...
		<div class="container">
			...
			<div class="row" style="display: flex; align-items: center">
				<div class="col-lg-2 col-md-6">
					<a href="/pet/review/read.do?review_no=${review.review_no-1}&state=READ" style="float: right;"><img src="/pet/resources/assets/images/direction_left.png" style="width: 50px; height: 50px"></a>
				</div>
				...
				<div class="col-lg-8 col-md-6">
					<div class="feature-box box-style">
						...
						<div class="display: flex; flex-direction: column;">
							...
							<div class="row">
								...
								<div class="col-2">
									<p style="font-size: 12px; font-weight: 400; color: rgb(158, 164, 179); line-height: 20px;">${review.review_rate}</p>
								</div>
							</div>
							<br/>
							<p>${review.review}</p>
					...
					<div class = "row">
						<div class = "col-lg-12">
							...
							<p style="font-weight: 600; color: #6A92FE; font-size: 18px; line-height: 40px">전체 후기 보기</p></a>
						</div>
					</div>
				...
				<div class="col-lg-2 col-md-6">
					<a href="/pet/review/read.do?review_no=${review.review_no+1}&state=READ"><img src="/pet/resources/assets/images/direction_left.png" style="width: 50px; height: 50px; transform: rotateY(180deg)"></a>
				</div>
			</div>
			<br/> 
			<br/>
