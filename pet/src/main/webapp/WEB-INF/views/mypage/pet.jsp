								...
								<div class="row">
									<div class="col-md-6">
										...
										<input type="text" name="weight" id="weight" placeholder="몸무게"
											value="${pet.pet_weight }" disabled>
										<legend>크기(cm)</legend>
										<input type="text" name="height" id="height" placeholder="크기"
											value="${pet.pet_size }" disabled>
									</div>
									...
									<div class="col-md-12">
										...
										<input type="text" name="animalhospital_name"
											id="hospital_name" placeholder="동물병원 이름"
											value="${pet.animalhospital_name}" disabled> <input
											type="text" name="animalhospital_addr" id="hospital_addr"
											placeholder="동물병원 주소" value="${pet.animalhospital_addr}"
											disabled>
									</div>
