					...
					<div class="contact-form-wrapper">
						...
						<form action="assets/php/mail.php" class="contact-form">
							...
							<div style="display: flex; position: relative;">
								<a href=""><img src="/resources/assets/images/dogf.jpg"
							...
							<div class="row">
								...
								<div>
									<fieldset>
										...
										<div class="row">
											<div class="col-md-4">
												<div>
													<input type="text" name="gender" id="gender" placeholder="남자아이"
										disabled="disabled">
								...
								<div class="row">
									...
									<input type="text" name="detailkind"
											id="dkind" placeholder="상세품종 &nbsp;&nbsp; ex)요크셔&nbsp;테리어" disabled="disabled">
											</div>
											</div>
											</fieldset>
											</div>
									...
									<input type="text" name="weight"
											id="weight" placeholder="Kg" style="text-align:  right" disabled="disabled">
									</div>
									</div>
									</fieldset>
									</div>
                                    ...
                                    <div class="col-12">
                                        <div class="button text-center">
                                           <button onclick="location='/pet/src/main/webapp/WEB-INF/views/mypage/pet2.jsp'" type="submit" class="theme-btn">수정</button>
