	...
	<section class="contact-section pt-130">
		<div class="container">
			...
			<div class="count" style="">
				<h7>
				<b style="color: #0D6EFD">전체 시터: ${total }</b></h7>
				</br>
				<h7>
				<b style="color: #0D6EFD">승인완료 시터: ${atotal }</b></h7>
				</br>
				<h7>
				<b style="color: #0D6EFD">미승인 시터: ${untotal }</b></h7>
			</div>
			<form action="/pet/admin/search.do" class="search-form">
				<div class="container">
					<div class="container row align-items-center pb-30"
						style="width: 200%; margin-left: 800px;">
						<div class="col-lg-12">
							<div class="row">
								<div class="col-lg-4">
								...
								<div class="col-lg-8">
									<input name="search_val" id="search_val" type="text"
										placeholder="Search">
									<button type="submit"
										style="margin-right: -90%; margin-top: -5%;">
										<i class="lni lni-search-alt" style="margin-left: 850px;"></i>
									</button>
								</div>
							</div>
						</div>
							...
							<tbody>
								...
								<c:forEach var="sitter" items="${sitterlist}" varStatus="status">
									<tr>
										...
										<th><a
											href="/pet/erp/sitter/read.do?sitter_id=${sitter.sitter_id}&state=UPDATE"><span
												id="${sitter.sitter_id}">${sitter.sitter_id}</span></a></th>
										...
										<%-- <td>${sitter.valid}</td> --%>
										<Div id="Pop"
											style="position: absolute; left: 100px; top: 100px; width: 100px; height: 100px; z-index: 1; display: none;">
											<td><a
												href="javascript:showPopUp('${sitter.sitter_id}')">${sitter.valid}</a></td>
